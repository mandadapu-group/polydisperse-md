...
if (ENABLE_MPI)
    ...
    if (cereal_FOUND)
        ...
        if (NOT TARGET cereal::cereal AND TARGET cereal)
            message(STATUS "Found cereal target. Muhammad's change: Instead of adding cereal::cereal alias, I add cereal as INTERFACE IMPORTED.")
            #add_library(cereal::cereal)
